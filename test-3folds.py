...
if __name__ == "__main__":
    ...
    data_dirs = [
        "/Users/pnr5sh/Documents/phd/maven/data/test/equalsplit",
        "data/test/equalsplit",
        "test/equalsplit",
        "equalsplit",
    ]
    # [
    ...
    if "spectral" in combinations:
        data_dirs = ["equalsplit_spectra", "data/test/equalsplit_spectra"] #["ZTFBTS_spectra/", "data/ZTFBTS_spectra/"]
