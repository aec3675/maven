...
if __name__ == "__main__":
    ...
    data_dirs = [
        "/Users/pnr5sh/Documents/phd/maven/data/test/equalsplit_randdrop",
        "data/test/equalsplit_randdrop",
        "test/equalsplit_randdrop",
        "equalsplit_randdrop",
    ]
    # [
    ...
    if "spectral" in combinations:
        data_dirs = ["equalsplit_randdrop_spectra", "data/test/equalsplit_randdrop_spectra"] #["ZTFBTS_spectra/", "data/ZTFBTS_spectra/"]
